 ...
 */
api.process = ({activeCtx, localCtx, options, termContext = false}) => {
    ...
    if(ctx === null) {
      if(termContext) {
        ...
        throw new JsonLdError(
          'Contexts can only be nullified inside of a term definition.',
          'jsonld.SyntaxError',
...
api.getInitialContext = (options) => {
  ...
  function _cloneActiveContext() {
    ...
    child.sealed = new Set(this.sealed);
    if('@language' in this) {
